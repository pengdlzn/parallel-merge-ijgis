...
(also see the state\_high value in the first row of \tabl\ref{tbl:sequence_greedy}).
...
The \emph{exception list} is~$[[1, 1]]$ for the example of \tabl\ref{tbl:sequence_greedy}.
...
(see columns~state\_low and state\_high in \tabl\ref{tbl:sequence_greedy}).

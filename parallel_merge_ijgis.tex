...
\input{parallel_merge_ijgis_setting}
...
\citet{Su1997aggregation,Sester2005Optimization} 
...
where in each step the least important area is merged into
its most compatible neighbor.
\textbf{merge the following three Peng2020AreaAgg }
...
\end{equation*}
As~$N_\mathrm{event} \ge n_\mathrm{step}$ is larger than or equal to~$n_\mathrm{step}$,
